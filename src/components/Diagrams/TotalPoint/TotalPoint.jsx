    ...
    <div className="totalPoints">
      ...
      <div className="icons">
        <ul>
          <li>
            <img
              src={require("../../../img/TotalalDiagram/minus.png")}
              alt=""
            />
          </li>
          <li>
            <img src={require("../../../img/TotalalDiagram/plus.png")} alt="" />
          </li>
          <li>
            <img
              src={require("../../../img/TotalalDiagram/carbon_zoom-in.png")}
              alt=""
            />
          </li>
          <li>
            <img src={require("../../../img/TotalalDiagram/home.png")} alt="" />
          </li>
          <li>
            <img src={require("../../../img/TotalalDiagram/hand.png")} alt="" />
          </li>
        </ul>
      </div>
      <div className="line">
